...
<div class="well well-sm">
    ...
    <form class="form-inline"id="frm-accidente" action="app?page=cliente&op=list" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <a class="btn btn-default" href="app?page=cliente&op=list">
                <span class="glyphicon glyphicon-refresh"></span>
            </a>
            <a class="btn btn-success" href="app?page=cliente&op=showedit">
        ...
        <table class="table table-hover" id="tabla">
            ...
            <tbody>
                <c:forEach var="r" items="${l}" > 
                    <tr>
                        <td width="5%">
                            <a class="btn btn-primary" href="app?page=cliente&op=showedit&id=${r.getId()}">
                                <span class="glyphicon glyphicon-edit"></span>
                            </a>
                        </td>
                        <td>${r.getNombre()} ${r.getApellido1()} ${r.getApellido2()}</td>
                        <td>${r.getObservaciones()}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table> 
